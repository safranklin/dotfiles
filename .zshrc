...
if [[ -f ~/.config/my/zsh-defer/zsh-defer.plugin.zsh ]]; then
   source ~/.config/my/zsh-defer/zsh-defer.plugin.zsh
...
[[ -f ~/.config/my/env.zsh ]] && defer source ~/.config/my/env.zsh
[[ -f ~/.config/my/apps.zsh ]] && defer source ~/.config/my/apps.zsh
[[ -f ~/.config/my/functions.zsh ]] && defer source ~/.config/my/functions.zsh
[[ -f ~/.config/my/aliases.zsh ]] && defer source ~/.config/my/aliases.zsh
[[ -f ~/.config/my/paths.zsh ]] && defer source ~/.config/my/paths.zsh

# Local overrides (gitignored — machine-specific config like work aliases)
for f in ~/.config/my/*.local.zsh(N); do defer source "$f"; done
